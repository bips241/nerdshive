# Nerd'sHive Antigravity Rules & Guidelines

> **Notice**: This file defines mandatory guidelines for all Antigravity and AI coding agents working on Nerd'sHive.  
> It is identical to `AGENTS.md` and `.agents/rules/workspace-rules.md`.
